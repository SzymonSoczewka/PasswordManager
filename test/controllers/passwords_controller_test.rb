...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference('Password.count') do
      post passwords_url, params: { password: { crypted_password: @password.crypted_password, password_salt: @password.password_salt } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { crypted_password: @password.crypted_password, password_salt: @password.password_salt } }
